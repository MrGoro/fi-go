    ...
    >
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="bg-muted/50 rounded-xl p-4 border border-border/50">
          <h4 className="font-semibold text-foreground mb-3 text-xs uppercase tracking-widest leading-none">Arbeitszeitregeln</h4>
          <div className="grid grid-cols-2 gap-y-2 text-xs">
            <span>Soll-Arbeitszeit:</span>
            <span className="font-medium text-foreground">{targetFormatted} Stunden</span>
            
            <span>Pause 1:</span>
            <span className="font-medium text-foreground">{BREAK_RULE_1_MIN_BREAK_MINUTES} Min (nach {BREAK_RULE_1_THRESHOLD_MINUTES / 60}h)</span>

            <span>Pause 2:</span>
            <span className="font-medium text-foreground">{BREAK_RULE_2_MIN_BREAK_MINUTES} Min (nach {BREAK_RULE_2_THRESHOLD_MINUTES / 60}h)</span>
        ...
        <div className="bg-muted/30 rounded-xl p-4 border border-border/30">
          <h4 className="font-semibold text-foreground/70 mb-3 text-xs uppercase tracking-widest leading-none">Version</h4>
